...
# 🎮 WE ARE SO DEAD — Community Edition

**Standalone Community Edition of a co-op zombie survival shooter.**
...
WE ARE SO DEAD is a cooperative first-person survival shooter set in a zombie-infested world where teamwork and resource management decide survival. This Community Edition is a standalone build distributed as a self-contained package, ready to play immediately with no storefront required and no additional software required. All base game content is included in this independent release.

This build is for players seeking a self-contained, offline Community Edition of the game for Windows PCs.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4796830/77995117dc26f87cf09c75ebcbafd5de158bf8cc/ss_77995117dc26f87cf09c75ebcbafd5de158bf8cc.1920x1080.jpg?t=1787326438" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4796830/9a6173eea66ce92a782d8d4d76baa2c3d3869405/ss_9a6173eea66ce92a782d8d4d76baa2c3d3869405.1920x1080.jpg?t=1787326438" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4796830/668676ec9bd8784275367234743b14d0dd7ae202/ss_668676ec9bd8784275367234743b14d0dd7ae202.1920x1080.jpg?t=1787326438" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- 🧟 **Zombie Survival** — Fight through hordes of infected in a hostile, resource-scarce world.
- 🔫 **First-Person Shooter Combat** — Fast-paced gunplay with a varied arsenal of ranged and melee weapons.
- 🤝 **Cooperative Play** — Team up with others via LAN or direct connection supported sessions.
- 🗺️ **Varied Environments** — Multiple maps with distinct layouts, hazards, and loot placement.
- 🎒 **Resource Management** — Scavenge ammunition, medical supplies, and gear to stay alive.
- ⚡ **Wave-Based Encounters** — Survive escalating enemy pressure across increasingly difficult rounds.
- 🛠️ **Loadout Customization** — Adapt weapons and equipment to fit different playstyles.
- 📦 **Self-Contained Package** — Standalone build — no storefront required and no additional software required.
- 🌐 **Offline Version** — Runs fully offline; network access is not needed to play.
- 🇬🇧 **English Interface** — Complete English interface and voice support included.
...
> 💡 **Saves location:** `%LOCALAPPDATA%\WEARESODEAD\Saved`
